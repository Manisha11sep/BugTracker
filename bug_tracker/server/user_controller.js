...
module.exports = {
  ...
  createUser: (req, res, next) => {
    ...
    //Using bcrypt for converting passport to hash values using salt rounds
    bcrypt.hash(password, saltRounds).then(hashedPassword => {
      dbInstance
        .create_user([username, hashedPassword, email, profile_pic])
        .then(data => {
          ...
          bcrypt 
            ...
            .catch(error => {
              res
                ...
                .json({
                  message:
                    "An error occurred; for security reasons it can't be disclosed"
                });
            });
        } else {
